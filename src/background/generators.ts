...
export class GetExampleController {
  ...
  },
  {
    ...
    promptOneFile:
      "You should generate the code of the controller unit test file FILENAME. ",
    prompt:
      "You should only generate the code of the unit test file of the controllers. The unit test files of a controller contains 'controller.spec.ts' in the name. You should not generate any other file.",
...
describe('GetExampleController', () => {
  ...
  },
  {
    ...
    regex: /service\.ts$/,
    promptOneFile:
      "You should generate the code of the service file FILENAME. ",
    prompt:
      "You should only generate the code of the service files. The service files contains 'service.ts' in the name. You should not generate any other file.",
...
export class ExampleService {
  ...
  },
  {
    ...
    promptOneFile:
      "You should generate the code of the service unit test file FILENAME. ",
    prompt:
      "You should only generate the code of the unit test files of the services. The unit test files of a service contains 'service.spec.ts' in the name. You should not generate any other file.",
...
describe('GetExampleService', () => {
  ...
  },
  {
    ...
    regex: /module\.ts$/,
    promptOneFile:
      "You should only generate the code of the module file FILENAME. ",
    prompt:
      "You should only generate the code of the module file. The module file contains 'module.ts' in the name. You should not generate any other file.",
...
export class HubloPoolOfferModule {}`,
  },
  {
    ...
    prompt:
      "You should only generate the code of the provider files. A provider file contains 'provider.ts' in the name. You should not generate any other file.",
...
export const ExampleProvider = Symbol('ExampleProvider')`,
  },
  {
    ...
    promptOneFile:
      "You should generate the code of the http provider file FILENAME. ",
    prompt:
      "You should only generate the code of the provider files. A provider file contains 'provider.ts' in the name. You should not generate any other file.",
...
export class ExampleProviderHttpImpl implements ExampleProvider {
  ...
  },
  {
    ...
    promptOneFile:
      "You should generate the code of the mongo provider file FILENAME. Prisma is used to make the queries.  ",
    prompt:
      "You should only generate the code of the provider files. A provider file contains 'provider.ts' in the name. You should not generate any other file.",
    example: `import { Injectable } from '@nestjs/common'
import {
...
export class ExampleProviderMongoImpl implements ExampleProvider {
  ...
  },
  {
    ...
    promptOneFile:
      "You should generate the code of the provider unit test file FILENAME. ",
    prompt:
      "You should only generate the code of the unit test files of the providers. The unit test files of the provider contains 'provider.spec.ts' in the name. You should not generate any other file.",
    example: `import {
  BadRequestException,
  ConflictException,
  NotFoundException,
...
export class GetExampleQueryDto {
  ...
  },
  {
    ...
    promptOneFile:
      "You should generate the code of the interceptor file FILENAME. ",
    prompt:
      "You should only generate the code of the interceptor files. The interceptor files contains '.interceptor.ts' in the name. You should not generate any other file.",
    example: `import {
  CallHandler,
  ExecutionContext,
  ForbiddenException,
...
export class GetExampleInterceptor implements NestInterceptor {
  ...
  },
  {
    ...
    regex: /\.exception\.ts$/,
    promptOneFile:
      "You should generate the code of the exception file FILENAME. The exception extends CustomError.  ",
    prompt:
      "You should only generate the code of the types files. The types files contains '.types.ts' in the name. You should not generate any other file.",
...
`,
  },
  {
    ...
    promptOneFile:
      "You should generate the code of the react hook file FILENAME. This hook is used to call the endpoint given on the specification. We use @tanstack/react-query to handle the request. ",
...
export const useWorkerOffersQuery = (
  ...
  },
  {
    ...
    promptOneFile:
      "You should generate the code of the MSW handler file FILENAME. This hook is used in unit tests to catch the call of the endpoint given on the specification. ",
...
`,
  },
  {
    ...
    promptOneFile:
      "In the file FILENAME, you should add the code of the endpoint URL from the given specifications. You should generate the import and the export. You should use a double chevron on the echo command to not erase the existing content. ",
...
`,
  },
  {
    ...
    promptOneFile:
      "In the file FILENAME, you should only import the msw interceptor. You should not do anything else. You should use a double chevron on the echo command to not erase the existing content. ",
  ...
  },
  {
    ...
    regex: /libs\/front\/api\/src\/(?!msw-handlers\/).*\/index\.ts$/,
    promptOneFile:
      "In the file FILENAME, you should only export the react hook. You should not do anything else. You should use a double chevron on the echo command to not erase the existing content. ",
